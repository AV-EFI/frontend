...
const deBase = {
  ...
  addtofavouritesparam: ({ named }: { named: (key: string) => string }) => `«${named('name')}» zu Favoriten hinzufügen`,
  addedtofavouritesparam: ({ named }: { named: (key: string) => string }) => `«${named('name')}» zu Favoriten hinzugefügt`,
  ...
  'refineBy': ({ named }: { named: (key: string) => string }) => `Nach ${named('label') || named('headerText')} verfeinern`,
  'refinementOption': ({ named }: { named: (key: string) => string }) => `Facette ${named('facetName')} auf Ebene ${named('category')}, Wert ${named('label')}, ${named('count')} Treffer, ${named('state')}`,
  ...
  "detailedViewLinkFor": ({ named }: { named: (key: string) => string }) => `Detailansicht für ${named('name')} öffnen`,
  "footer": "Fußzeile",
  "works": "Werke",
  "work": "Werk",
