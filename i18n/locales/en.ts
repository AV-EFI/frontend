...
const avefiBase = {
  ...
  'favouritesTabDisabled': 'Add favourites to enable this tab.',
  'comparisonItemRemoved': 'Removed {name} from comparison.',
  'favouriteItemRemoved': 'Removed {name} from favourites.',
  'comparisonListCleared': 'Comparison list cleared ({count} items).',
  'favouritesListCleared': 'Favourites list cleared ({count} items).',
  'comparisonNavigationError': 'Comparison could not be opened. Please check the selected items.',
  'clipboardCopySuccess': 'Copied to clipboard.',
  'clipboardCopyError': 'Could not copy to clipboard.',
  'valueTransferred': 'Value transferred to the result.',
  'valueTransferError': 'Value could not be transferred.',
  ...
  "filmRelatedMaterialsBrowserDescription": "Search, filter, sort and page through materials related to this work variant.",
  "filmRelatedMaterialsSearchPlaceholder": "Search film-related materials",
  "manifestationsAndFilmRelatedMaterials": "Manifestations and Film-Related Materials",
  ...
  "clearMaterialFilters": "Clear filters",
  "noFilmRelatedMaterialsResults": "Try adjusting the filters or search query.",
  ...
  'parts': 'Parts',
  "referencesAndWorkRelations": "References",
  "workReferenceAtAuthority": "{title} on {authority}",
  ...
  'itemLevelInfoShort': 'In this dataset',
  'itemLevelInfoAvailableHelp': 'Preview of properties available in this dataset.',
  ...
  "filterItemsAndManifestationsHelp": "Open filter options for manifestations and items. Arrow keys move between options. Tab leaves the list. Escape closes the list.",
  "filterViewList": "List",
