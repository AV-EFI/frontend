...
export default defineI18nConfig(() => ({
    ...
    messages: {
        en: {
            ...
            "glossary.description": "The glossary provides definitions and explanations of key terms used in AVefi. It helps users understand the terminology related to audiovisual works, manifestations, items, and more.",
            "glossary.term": "Term",
            ...
            "vocab": {
                ...
                "field": "Field",
                "filter": "Filter",
                "filterPlaceholder": "Filter value / authority data / provider…",
                "onlyWithNormdata": "Only with authority data",
                "perPage": "Per page",
                "exportAllResults": "Export all results",
                "exportAllComplete": "Export all (without filters)",
                "export": "Export",
                "exporting": "Exporting...",
                ...
                "limitedResultsInfo": "{total} results found, but only the first 100 are displayed. Use the \"Export all results\" button or alphabetic filters for the complete dataset.",
                "filterByLetter": "Filter by initial letter:",
                "all": "All",
                "value": "Value",
                "normdata": "Authority data",
                "provider": "Data provider",
                "docs": "Docs",
                "loading": "Loading...",
                "noEntries": "No entries found.",
                "exportRow": "Export row as CSV",
                "showInSearch": "Show in search",
                "page": "Page",
                "of": "of",
                "entries": "entries",
                "disclaimer": "Note: The authority data and provider columns are based on an example path in the backend and need to be adapted to the AVefi mapping.",
                "fields": {
                    "hasSubject": "Keywords (has_subject)",
        ...
        de: {
            ...
            "glossary.description": "Das Glossar bietet Definitionen und Erklärungen zu wichtigen Begriffen, die in AVefi verwendet werden. Es hilft den Nutzern, die Terminologie im Zusammenhang mit audiovisuellen Werken, Manifestationen, Exemplaren und mehr zu verstehen.",
            ...
            'allItemsEmpty': 'Alle Exemplare leer',
            'allItemsEmptyTooltip': 'Alle Exemplare in diesem Werk haben keine zusätzlichen Metadaten',
            ...
            "vocab": {
                "pageTitle": "Vocab / Normdaten-Export",
                "pageDescription": "Zeigt distinct Werte für ausgewählte Felder, inkl. Normdaten-Link und Datenlieferant.",
                "field": "Feld",
                "filter": "Filter",
                "filterPlaceholder": "Wert / Normdaten / Provider filtern…",
                "onlyWithNormdata": "Nur mit Normdaten",
                "perPage": "Pro Seite",
                "exportAllResults": "Alle Ergebnisse exportieren",
                "exportAllComplete": "Export Alles (ohne Filter)",
                "export": "Export",
                ...
                "completeDataset": "Kompletter Datensatz",
                "limitedResultsInfo": "Es wurden {total} Ergebnisse gefunden, aber nur die ersten 100 werden angezeigt. Verwenden Sie den \"Alle Ergebnisse exportieren\" Button oder alphabetische Filter für den vollständigen Datensatz.",
                "filterByLetter": "Filter nach Anfangsbuchstabe:",
                "all": "Alle",
                "value": "Wert",
                "normdata": "Normdaten",
                "provider": "Datenlieferant",
                "docs": "Docs",
                "loading": "Lädt aus Elasticsearch…",
                "noEntries": "Keine Einträge gefunden.",
                "exportRow": "Row als CSV exportieren",
                "showInSearch": "In Suche anzeigen",
                "page": "Seite",
                "of": "von",
                "entries": "Einträge",
                "disclaimer": "Hinweis: Die Normdaten- und Provider-Spalten basieren auf einem Beispiel-Pfad im Backend und müssen an das AVefi-Mapping angepasst werden.",
                "fields": {
