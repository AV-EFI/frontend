...
export default defineI18nConfig(() => ({
    ...
    messages: {
        en: {
            ...
            'suggestSearchToAVefi': 'Suggest search/query to AVefi team',
            'share': {
            ...
            "normdata": {
                ...
                "limitedResultsInfo": "Only the first 100 results are shown of {total} total.",
        ...
        de: {
            ...
            "normdata": {
                ...
                "limitedResultsInfo": "Es werden nur die ersten 100 Ergebnisse von {total} insgesamt angezeigt.",
