...
export default defineI18nConfig(() => ({
    ...
    messages: {
        en: {
            ...
            'alpha': 'The system is still in development. Please be aware that not all features are available yet.',
            'avefi_Item': 'Item',
        ...
        de: {
            ...
            'alpha': 'Das System ist noch in der Entwicklungsphase. Bitte haben Sie Verständnis, dass noch nicht alle Funktionen verfügbar sind.',
            'avefi_Item': 'Exemplar',
            'avefi_Manifestation': 'Manifestation',
