...
export default defineI18nConfig(() => ({
    ...
    messages: {
        en: {
            ...
            'total': 'Total',
            'toggleManifestation': ({named}) => `${named('manifestationId')} click on the manifestation to view details`,
            'nextPage': 'Next page',
            'prevPage': 'Previous page',
            'searchInFacet': ({ named }) => `Search in ${named('facetName')}`,
            'refineBy': ({ named }) => `Refine by ${named('label')}`,
            'showFacetItems': 'Show facets',
            'preferences': 'Preferences',
            'captchaText': ({named}) => `What is ${named('name')}?`,
            ...
            'location': 'Location',
            'copyEFI': ({named}) => `Copy efi of ${named('category')}`,
            'dashboard': 'Dashboard',
            ...
            'exportGithubProject': 'Export GitHub Project',
            'githubProjectExport': 'GitHub Project Export',
            'githubUserStories': 'GitHub User Stories',
            'loadingGithubProject': 'Loading GitHub project board...',
            'githubExportSuccess': 'GitHub project board exported successfully!',
            'githubExportError': 'Failed to export GitHub project board',
            'facettype': 'Type',
            'facetyear': 'Year',
            ...
            'copyValueToTargetModelPropertyName': ({ named }) => `Transfer value of ${named('name')} to result`,
        ...
        de: {
            ...
            addtocomparisonparam: ({ named }) => `«${named('name')}» zum Vergleich hinzufügen`,
            addedtocomparisonparam: ({ named }) => `«${named('name')}» zum Vergleich hinzugefügt`,
            ...
            'total': 'Gesamt',
            'toggleManifestation': ({named}) => `Klicken Sie auf die Manifestation, um Details zu ${named('manifestationId')} anzuzeigen`,
            'nextPage': 'Nächste Seite',
            'prevPage': 'Vorherige Seite',
            'searchInFacet': ({ named }) => `In ${named('facetName')} suchen`,
            'refineBy': ({ named }) => `Nach ${named('label')} verfeinern`,
            ...
            'copyEFI': ({named}) => `${named('category')} efi kopieren`,
            ...
            'exportGithubProject': 'GitHub Projekt exportieren',
            'githubProjectExport': 'GitHub Projekt Export',
            'githubUserStories': 'GitHub User Stories',
            'loadingGithubProject': 'GitHub Projektboard wird geladen...',
            'githubExportSuccess': 'GitHub Projektboard erfolgreich exportiert!',
            'githubExportError': 'GitHub Projektboard Export fehlgeschlagen',
            ...
            'info': 'Info',
            'copyValueToTargetModelPropertyName': ({ named }) => `Übertrage Wert von ${named('name')} in das Ergebnis`,
            ...
            'captchaText': ({named}) => `Was ist ${named('name')}?`,
            ...
            "messageHelpText": "Bitte geben Sie Ihre Nachricht ein.",
            "openMenu": "Menü öffnen",
            "mainMenu": "Hauptmenü",
            "login": "Anmelden",
            "Login": "Anmelden",
            "captchaHelpText": "Geben Sie die Antwort auf die Rechenaufgabe ein, um zu bestätigen, dass Sie kein Bot sind.",
            "mainSearch": "Hauptsuche",
            "submitSearch": "Suche absenden",
            "footer": "Fußzeile",
            "footerPreferences": "Fußzeilen-Einstellungen",
            "footerInfo": "Informationen",
            "footerSponsoring": "Förderung",
