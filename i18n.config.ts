...
export default defineI18nConfig(() => ({
    ...
    messages: {
        en: {
            ...
            'enterYourAnswer': 'Enter your captcha answer',
            ...
            'grid': 'Grid',
            'in_language_code': 'Language',
            'includeMissingProductionYear': 'Only Records with production year',
            'includeMissingProductionYearExtended': 'Show only records that have production year information',
        ...
        de: {
            ...
            "has_format": "Format",
            "item_element_type": "Elementtyp",
            "in_language_code": "Sprache",
            "has_colour": "Farbe",
            "has_sound_type": "Tonart",
            "productionyear": "Produktionsjahr",
            "country": "Land",
            'bannerSection': 'Ausgewählte Sammlungen und Highlights aus der Welt der Filmdaten',
            'featuredContent': 'AVefi präsentiert ausgewählte Sammlungen und wichtige Erkenntnisse aus dem Bereich der Filmdaten. Entdecken Sie eine Vielzahl von Datensätzen, von umfassenden Filmografien bis hin zu detaillierten technischen Spezifikationen, die eine eingehende Analyse und neue Einblicke in die Filmlandschaft ermöglichen.',
            ...
            'grid': 'Tabelle',
            'in_language_code': 'Sprache',
            'includeMissingProductionYear': 'Nur Datensätze mit Produktionsjahr',
            'includeMissingProductionYearExtended': 'Nur Datensätze anzeigen, die Information zu Produktionsjahr besitzen',
            'info': 'Info',
            'items': 'Exemplare',
            ...
            'enterYourAnswer': 'Geben Sie Ihre Captcha-Antwort ein',
