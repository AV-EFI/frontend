...
export default defineEventHandler(async (event) => {
  ...
  interface NormdataBucket {
    key: string;
    doc_count: number;
    all_docs?: { hits?: { hits?: Array<{ _source?: unknown }> } };
  }
  interface NormdataSearchResponse {
    aggregations?: { values?: { buckets?: NormdataBucket[] } };
  }

  let res: NormdataSearchResponse | undefined;
  try {
