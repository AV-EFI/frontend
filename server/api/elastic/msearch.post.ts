            ...
            hooks: {
              ...
              allParams[indexName] && typeof allParams[indexName] === 'object'
                  ...
                  : allParams;
                        ...
                        // --- keep event type on manifestation level (mapping is nested)
                        ...
                        if (inLanguageCodeValues.length > 0) {
                            itemsMust.push({
                                terms: {
                                    'manifestations.items.has_record.in_language.code.keyword': inLanguageCodeValues
                                }
                            });
                        }
                        ...
                        if (hasColourTypeValues.length > 0) {
                            itemsMust.push({
                                terms: {
                                    'manifestations.items.has_record.has_colour_type.keyword': hasColourTypeValues
                                }
                            });
                        }
                        ...
                        if (hasSoundTypeValues.length > 0) {
                            itemsMust.push({
                                terms: {
                                    'manifestations.items.has_record.has_sound_type.keyword': hasSoundTypeValues
                                }
                            });
                        }
                        ...
                        if (hasDurationStringValues.length > 0) {
                            itemsMust.push({
                                terms: {
                                    'manifestations.items.has_record.has_duration.has_value.keyword': hasDurationStringValues
                                }
                            });
                        }
