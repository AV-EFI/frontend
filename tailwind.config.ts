...
module.exports = {
  safelist: [
    ...
    // ✅ ensure DaisyUI toggle color utilities are kept even if used dynamically
    { pattern: /^toggle-(primary|secondary|accent|info|success|warning|error)$/ }
  ],
  content: [
    './app.vue',
      ...
      addUtilities({
        '.text-nuggets-5280': {
          ...
          WebkitMaskImage: `
            ...
            repeating-linear-gradient(45deg, black 0px, black 1px, transparent 1px, transparent 4px)
          `,
  ...
  daisyui: {
    ...
    themes: [
      {
        avefi_light: {
          ...nord,                    // DaisyUI base (light)
          ...lightThemeColors,        // your palette
          ...
          'base-content': lightThemeColors.base?.content || '#212529',
        },
      },
      {
        avefi_dark: {
          ...night,                   // DaisyUI base (dark)
          ...darkThemeColors,
          ...
          'neutral-content': darkThemeColors.neutral?.content || '#ffffff',
          'base-100': darkThemeColors.base?.[100] || '#1e1e1e',
          'base-content': darkThemeColors.base?.content || '#e8eaed',
        },
      },
      {
        avefi_bauhaus: {
          ...lofi,                    // geometric, high-contrast
          primary:  '#4d768d',
          accent:   '#ff1d25',
          neutral:  '#111111',
          'base-100': '#f5f5f2',
