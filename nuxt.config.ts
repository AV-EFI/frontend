...
export default defineNuxtConfig({
      ...
      style: [
        {
          innerHTML: `html[data-theme="avefi_dark"], [data-theme="avefi_dark"] {
            background:oklch(13% 0.028 261.692) !important;
  ...
  runtimeConfig: {
    public: {
      ...
      botUaAllowlist: (
        ...
        'Googlebot,Google-InspectionTool,Bingbot,msnbot,BingPreview,BingVideoPreview,MicrosoftPreview,AdIdxBot,Applebot,DuckDuckBot,DuckAssistBot,Twitterbot,facebookexternalhit,LinkedInBot,Slackbot,TeamsBot,OAI-SearchBot,Claude-SearchBot,PerplexityBot'
      )
        .split(',')
        .map((s) => s.trim())
        .filter(Boolean),
  ...
  sitemap: {
    ...
    urls: [
      ...
      { loc: '/search/?creators=Troller%2C%20Georg%20Stefan' },
      ...
      { loc: '/search/?creators%5B0%5D=Nekes%2C%20Werner' },
      { loc: '/search/?creators%5B0%5D=Wildenhahn%2C%20Klaus' },
      { loc: '/search/?creators%5B0%5D=Nestler%2C%20Peter' },
      { loc: '/search/?creators%5B0%5D=Nickel%2C%20Gitta' },
