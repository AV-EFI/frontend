...
<template>
    <div class="p-6 mx-auto max-w-6xl space-y-6">
        ...
        <div class="flex flex-wrap items-end gap-4">
            ...
            <div class="form-control w-full max-w-xs">
                <label class="label">
                    <span class="label-text text-sm font-medium">{{ $t('normdata.filter') }}</span>
                </label>
                <div class="relative">
            ...
            <div class="relative inline-block ml-auto">
                ...
                <div v-if="menuOpen" id="export-menu" role="menu"
                    ...
                    <ul class="menu menu-compact">
                        ...
                        <li class="menu-title">
                            <span>{{ $t('normdata.fullExportTitle') }}</span>
                        </li>
                        <li role="none">
...
const pageTitle = computed(() => {
    if (fieldLabel && seoFilter) {
        return t('seo.normdata.titleWithFieldAndFilter', { field: fieldLabel, filter: seoFilter });
    }
    if (fieldLabel) {
        return t('seo.normdata.titleWithField', { field: fieldLabel });
    }
    return t('seo.normdata.title');
});

// Dynamic description
const pageDescription = computed(() => {
    if (fieldLabel && seoFilter) {
        return t('seo.normdata.descriptionWithFieldAndFilter', { field: fieldLabel, filter: seoFilter });
    }
    if (fieldLabel) {
        return t('seo.normdata.descriptionWithField', { field: fieldLabel });
    }
...
const fieldOptions = computed(() => [
    { key: 'has_subject' as FieldKey, label: t('normdata.fields.hasSubject') },
    { key: 'has_genre' as FieldKey, label: t('normdata.fields.hasGenre') },
]);
