...
const cardItems = ref<CardItem[]>([
    ...
    },
    {
        ...
        imgAlt: 'Fotografie v. Hermann Schlenker',
        imgCoverType: 'object-center',
        imgSourceLink: 'https://www.weltkulturenmuseum.de/',
        imgSourceText: 'Museum der Weltkulturen, Frankfurt am Main',
        imgAuthor: 'Museum der Weltkulturen, Frankfurt am Main',
        imgLicense: 'In Copyright',
        imgLicenseLink: 'https://rightsstatements.org/vocab/InC/1.0/',
        imgCollection: 'Weltkulturen Museum Frankfurt',
        imgAccessionNumber: 'OzB001491',
        imgCaption: 'Fotografie v. Hermann Schlenker. Museum der Weltkulturen, Frankfurt am Main.',
        ...createResponsiveCardMedia('schlenker', 213, 256),
    },
    /*
    {
        title: 'ddrTitle',
