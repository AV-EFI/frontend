...
/**
  ...
  *
  * @checksum - 5272cfbad00a3004f62bb9b5ae32c33f3356e83dfa4786bf77fdcfd2d7cde9a1
  * @variables - radius=rounded-md,accentColor=bali-hai,colorTemperature=slate,spacing=1.5,scale=base,inputShadow=shadow-none,baseColorShade=500,borderShadeLightMode=300,borderShadeDarkMode=500,inputMaxWidth=max-w-[20em],tagRadius=rounded-sm,swatchRadius=rounded-sm
  * @theme - regenesis
  **/
...
const classes: Record<string, Record<string, boolean>> = {
    ...
    "rating__itemsWrapper": {
        "relative": true,
        "inline-flex": true,
        "focus:border-bali-hai-500": true
    },
    "rating__onItemRow": {
        "h-full": true,
        "w-full": true
    ...
    "rating__ratingItem": {
        ...
        "focus-within:outline-bali-hai-500": true,
        "w-[1.5em]": true,
        "h-[1.5em]": true
    },
    ...
    "transferlist__transferlistListItem": {
        ...
        "dark:data-[is-active=true]:ring-bali-hai-600": true,
        "dark:aria-selected:ring-bali-hai-600": true,
