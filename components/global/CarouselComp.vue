  ...
  <div>
    ...
    <div class="carousel-container items-center relative hidden bg:white/80 dark:bg-base-200/60 lg:flex rounded-xl">
      <button :alt="$t('togglePreviousSlide')" :aria-label="$t('togglePreviousSlide')"
        class="lg:flex my-auto z-10 p-2 bg-primary text-white rounded-full bg-opacity-50 w-11 h-11 min-w-[44px] min-h-[44px] items-center justify-center lg:mr-4 dark:bg-gray-600 dark:text-gray-200 lg:absolute lg:top-1/2 lg:transform lg:-translate-y-1/2"
      ...
      <button
        class="z-10 my-auto lg:flex p-2 bg-primary text-white rounded-full bg-opacity-50 w-11 h-11 min-w-[44px] min-h-[44px] items-center justify-center lg:ml-4 dark:bg-gray-600 dark:text-gray-200 lg:absolute lg:top-1/2 lg:transform lg:-translate-y-1/2 lg:right-0"
        style="min-width:44px;min-height:44px;"
    ...
    <div class="lg:hidden w-full relative">
      <div ref="carouselRef" class="carousel carousel-center w-full bg-white/90 dark:bg-base-200 rounded-box p-4 overflow-x-auto scroll-smooth flex">
        <div
        ...
        >
          <figure class="w-full">
            <div v-if="item.src" class="relative w-full h-48 md:h-56 lg:h-64 rounded overflow-hidden bg-white">
              <div
                class="absolute inset-0 w-full h-full object-cover bg-white scale-110"
                aria-hidden="true"
              >
