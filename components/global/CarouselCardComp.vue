<template>
  <div class="relative w-full">
    ...
    <div ref="carouselRef" class="carousel carousel-center w-full rounded-box p-4 overflow-x-auto scroll-smooth snap-none">
        <div
        ...
        <figure class="w-full">
          ...
          <figcaption v-if="item.imgSourceText" class="h-auto min-h-12 break-words text-xs text-gray-500 mt-2 px-2 dark:text-gray-400">
