      ...
      <div class="drawer-side z-50">
        ...
        <div
          ...
          <div role="tablist" class="tabs tabs-bordered justify-stretch w-full">
            <input id="comparison_list_tab" type="radio" name="drawer_tabs" role="tab" checked
              :class="['tab lg:!w-64', objectListStore.objects.length === 0 && 'tab-disabled disabled']"
              :aria-label="$t('comparison')">
            <div role="tabpanel" class="tab-content bg-base-200 dark:bg-gray-800 dark:text-white">
            ...
            <input id="shopping_cart_tab" type="radio" name="drawer_tabs" role="tab"
